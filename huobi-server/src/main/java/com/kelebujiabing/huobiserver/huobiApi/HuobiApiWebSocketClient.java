...
import com.kelebujiabing.huobiserver.huobiApi.domain.enums.MergeLevel;
import com.kelebujiabing.huobiserver.huobiApi.domain.enums.Resolution;
import com.kelebujiabing.huobiserver.huobiApi.domain.event.DepthEventResp;
import com.kelebujiabing.huobiserver.huobiApi.domain.event.KlineEventResp;
import com.kelebujiabing.huobiserver.huobiApi.domain.event.MarketDetailResp;
import com.kelebujiabing.huobiserver.huobiApi.domain.event.TradeDetailResp;
import com.kelebujiabing.huobiserver.huobiApi.domain.resp.ApiCallback;
